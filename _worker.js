...
let userID = '56b7a13a-9693-44e5-af28-5545e40e7f77';
            ...
            if (!upgradeHeader || upgradeHeader !== 'websocket') {
                ...
                switch (url.pathname) {
                    ...
                    case '/login':
                        ...
                        if (!pwd) await env.bpb.put('pwd', '7dbEr!Djp225!si');
...
const buildDNSObject = async (remoteDNS, localDNS, blockAds, bypassIran, blockPorn, isWorkerLess) => {
    ...
    if (isWorkerLess) {
        ...
        const resolvedCLDomain = await resolveDNS('ip111.cn.cdn.cloudflare.net');
